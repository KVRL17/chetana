...
export const metadata = createPageMetadata({
  title: "Counselling Frequently Asked Questions",
  description: "Answers about counselling services, appointments, languages, online sessions, location and training programs at Chetana in Atchutapuram.",
  path: "/faq",
});
