        ...
        <div className="relative overflow-hidden rounded-[1.55rem] bg-primary px-5 py-8 text-white shadow-[0_24px_70px_rgba(23,63,69,.18)] sm:rounded-[2rem] sm:px-10 sm:py-10 lg:px-14 lg:py-14 lg:shadow-[0_30px_90px_rgba(23,63,69,.2)]">
          ...
          <div className="relative grid gap-7 sm:gap-10 lg:grid-cols-[1.12fr_.88fr] lg:items-end">
            <div className="text-center lg:text-left">
              ...
              <h2 className="mx-auto mt-3 max-w-3xl text-[clamp(2rem,9vw,2.65rem)] font-[760] leading-[1.045] sm:mt-4 lg:mx-0 lg:text-[clamp(2.2rem,4vw,3.8rem)] lg:leading-[1.04]">You do not have to solve everything before asking for guidance.</h2>
              <p className="mx-auto mt-4 max-w-2xl text-[13px] leading-6.5 text-white/65 sm:mt-5 sm:text-base sm:leading-7 lg:mx-0">Tell us what you would like support with. We can help you choose the right service and a suitable session format.</p>
            </div>
